    ...
    for team in teams:
        if str(team[4]) != "--":
            ...
            if (positive_ml <= -175 and positive_ml >= -400):
                ...
                string_teams = "<table><tbody>" + "<tr><td>" + str(team[0]) + " " + str(team[4]) + "</td></tr>" + "</tbody></table>\n"
...
</td></tr></table><p><a href = "https://www.espn.com/mlb/lines"> ESPN MLB Daily Stats </a>
</p></div></body></html>
"""
...
string_final = string_header + str(final_date) + "<p><b>Teams with stats between -175 and -400</b></p>\n" + str(final_results) + string_footer
